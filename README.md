...
synthetic seeds — **267 seed files total now** (7 from VLAN/Modbus/DNS
...
**Recommended build order, updated now that SCTP and M3UA are both
done**: AMQP next (substantial, self-contained real traffic, no
prerequisite) → the DHCP option breadth extension (cheap, can go

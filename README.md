...
synthetic seeds — **277 seed files total now** (7 from VLAN/Modbus/DNS
...
**Roadmap status: complete, with one deliberate exception.** SCTP,
M3UA, M2UA, AMQP, the DHCP option breadth extension, LLMNR, STP, PIM,
and AppleTalk are all done. Only the Cisco SNAP protocol remains
unbuilt — not from lack of time, but because this project doesn't
have confident, verified knowledge of its exact sub-protocol format,
and won't guess at wire-level structure the way it has consistently
